...
<div style="margin: 10px;padding: 10px">
    <form role="form" name="formMain">
        ...
        <div class="col-lg-2">
            <input name="bcmc" type="text" class="form-control" value=<%=request.getAttribute("bcmc")%>>
        </div>
        <div class="checkbox">
            <label>
                <input name="sfcr" type="checkbox" name="chkSfcr" id="idSfcr" checked=<%=request.getAttribute("sfcr")%>>是否次日
            </label>
        </div>
        <label class="col-sm-2 control-label">上班开始时间</label>
        <input name="sbkssj" type="text" class="form-control" value=<%=request.getAttribute("sbkssj")%>>
        <label class="col-sm-2 control-label">上班结束时间</label>
        <input name="sbjssj" type="text" class="form-control" value=<%=request.getAttribute("sbjssj")%>>
        <label class="col-sm-2 control-label">休息开始时间</label>
        <input name="ksxxsj" type="text" class="form-control" value=<%=request.getAttribute("ksxxsj")%>>
        <label class="col-sm-2 control-label">休息结束时间</label>
        <input name="jsxxsj" type="text" class="form-control" value=<%=request.getAttribute("jsxxsj")%>>
